...
for (const path of ["apps/web/index.html", "README.md", "README.zh-CN.md", "docs/CODEX_CONNECT.md", "docs/CODEX_CONNECT.zh-CN.md", "docs/releases/0.1.0-alpha.2.md", "packages/codex-connect/README.md"]) {
...
assert.match(webDomain, /@gatherthread\/codex-connect@0\.1\.0-alpha\.2/);

const installer = await readFile(join(root, "deploy/aliyun-ecs/install.sh"), "utf8");
assert.match(installer, /release_version="0\.1\.0-alpha\.2"/);
