...
- Use Git for Windows-compatible null-device paths for isolated server Git operations, and make the storage-quota regression independent of filesystem-specific directory sizes.
