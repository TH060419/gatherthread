...
This project studies existing open-source work. Unless a future file explicitly says otherwise, the initial implementation is original and no source code has been copied.
