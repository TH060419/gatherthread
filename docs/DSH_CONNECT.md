...
- Writable GatherThread sessions appear as editable native DSH conversations, each titled `<session> · 共序 · MULTI|SOLO` so the DSH session list separates them from plain local conversations.
