...
| [0006](0006-project-first-collaboration-boundary.md) | Use projects as the collaboration and local-agent binding boundary | accepted | 2026-08-25 |
...
| [0010](0010-explicit-session-lifecycle-and-synchronized-names.md) | Start projects empty and synchronize session names | accepted | 2026-08-25 |
