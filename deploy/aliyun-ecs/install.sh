...
Run this from /opt/gatherthread/releases/0.1.0-alpha.1 on an Ubuntu 22.04 or
...
grep -Eq '"version": "0\.1\.0-alpha\.1"' "$repository_root/package.json" || {
  printf '%s\n' "The source tree is not GatherThread 0.1.0-alpha.1." >&2
  exit 78
}
