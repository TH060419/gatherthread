...
Run this from /opt/gatherthread/releases/0.1.0-alpha.2 on an Ubuntu 22.04 or
...
grep -Eq '"version": "0\.1\.0-alpha\.2"' "$repository_root/package.json" || {
  printf '%s\n' "The source tree is not GatherThread 0.1.0-alpha.2." >&2
  exit 78
}
