...
(function () {
  ...
  var I18N = {
    ...
    "sessions.solo.h3": { zh: "个人独奏", en: "Solo" },
    ...
    "sessions.multi.h3": { zh: "多人共序", en: "Multi" },
    ...
    "final.h2":  { zh: "立即开始本地端到端运行。", en: "Run it locally, end to end." },
    "final.cta1": { zh: "克隆仓库", en: "Clone the repo" },
