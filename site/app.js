...
(function () {
  ...
  var I18N = {
    ...
    "connect.c2.p":  { zh: "还没有资格码？在 GitHub 发起 Alpha 测试申请 Issue。请勿在公开 Issue 中留下邮箱、令牌或其他个人信息。",
                       en: "No qualification code yet? Open an Alpha access Issue on GitHub. Do not post email, tokens, or other personal information in public Issues." },
